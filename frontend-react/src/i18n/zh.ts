const zh = {
  translation: {
    ...
    "preview.start-analysis": "问 Agent ->",
    "preview.analysis-hint": "表数据确认无误后，进入 Agent Analysis。",
    ...
    "history.description": "辅助活动记录，用于回查之前的 Agent 分析和 Expert SQL，不替代主流程。",
    ...
    "sidebar.brand-subtitle": "上传 -> Agent -> 答案",
    ...
    "home.hero-title": "上传数据，问 Agent，看答案",
    "home.hero-subtitle": "更简单的 CSV/Excel 分析流程：上传数据表，用自然语言问 Agent，然后查看答案、SQL、证据、warning 和工具轨迹。",
    "home.upload-data": "上传数据",
    "home.upload-hint": "第一步：导入 CSV/Excel 并预览数据表",
    "home.start-analysis": "Agent Analysis",
    "home.start-analysis-hint": "第二步：提问并查看答案",
    ...
    "home.deploy-notice": "推荐路径：上传数据 -> Agent Analysis -> 结果。Expert SQL 保留给高级用户。",
    ...
    "workspace.query-redirect": "Expert SQL 现在是 Agent Analysis 内的高级模式。",
    "workspace.goto-workspace": "前往 Agent Analysis",
    ...
    "agent.loading": "正在运行 Agent Analysis...",
