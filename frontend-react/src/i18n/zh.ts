const zh = {
  translation: {
    ...
    "dashboard.upload-data": "1. 上传数据",
    "dashboard.upload-hint": "上传 CSV 或 Excel 文件开始分析",
    "dashboard.ask-questions": "2. 提出问题",
    "dashboard.ask-hint": "用自然语言让 AI 分析你的数据",
    "dashboard.explore-results": "3. 探索结果",
    "dashboard.explore-hint": "获取洞察、图表、SQL 和深入调查",
    "dashboard.start-analysis": "开始首次分析",
    "dashboard.system-status": "系统状态",
    "dashboard.recent-analyses": "最近分析",
    "dashboard.recent-queries": "最近查询",
    "dashboard.ready-to-analyze": "准备分析",
    "dashboard.ready-hint": "你有 {{count}} 张表。试试用 AI 提问。",
    "dashboard.start-btn": "开始分析",
    ...
    "dashboard.data-hint": "上传和管理数据集",
    "dashboard.query-hint": "编写和执行 SQL 查询",
    "dashboard.analyze-hint": "AI 驱动的数据分析",
    ...
    "inv.title": "调查工作区",
    "inv.subtitle": "AI 优先的数据分析",
    "inv.start-hint": "提出一个问题，开始数据调查。",
    "inv.question-placeholder": "例如：营收最高的品类是哪些？",
    "inv.table-label": "数据集",
    "inv.mode-label": "分析模式",
    ...
    "inv.recent-runs": "最近调查",
    "inv.no-recent-runs": "暂无调查记录。在上面开始一次调查。",
