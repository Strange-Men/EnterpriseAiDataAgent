const en = {
  translation: {
    ...
    "astryx.provider.mock-desc": "This result is generated by the mock analysis path. It is suitable for demonstration, not a live model response.",
    "astryx.provider.fallback-title": "Simulated result after provider fallback",
    "astryx.provider.fallback-desc": "The requested model service timed out or was unavailable, so this is a simulated analysis result for reference. Retry the real model later.",
    "astryx.provider.error-title": "Model analysis failed",
    "astryx.provider.error-desc": "The requested model failed and no fallback result is available. Check provider configuration and retry.",
    ...
    "astryx.error.upload-timeout": "File processing timed out. Please retry or upload CSV instead.",
