const en = {
  translation: {
    ...
    "preview.description": "Review sample rows and confirm that the fields are ready for analysis.",
    ...
    "preview.analysis-hint": "Once the data looks ready, continue to the analysis workspace.",
    ...
    "table.current-card-desc": "This table is used as the default data source for natural language analysis and expert SQL.",
    ...
    "history.description": "Review, reuse, and export previous AI analyses and SQL queries.",
