const en = {
  translation: {
    ...
    "home.start-analysis-hint": "Step 2: ask a question and review the answer",
    ...
    "workspace.generate-sql-analyze": "Run Agent",
    ...
    "workspace.expert-sql-title": "Expert SQL",
    "workspace.expert-sql-hint": "Advanced mode for users who want to inspect, edit, and run SQL directly.",

    // Agent Analysis
    "agent.title": "Agent Analysis",
    "agent.subtitle": "Ask a question about the current table. The Agent can choose tools, use the selected provider, fall back to Mock when needed, and return answer, SQL, evidence, warnings, and trace.",
    "agent.request.title": "Ask Agent",
    "agent.request.description": "Choose a table, select a provider, and describe the analysis you need.",
    "agent.provider.label": "Provider",
    "agent.provider.hint": "Provider requested is shown separately from provider used, so Mock fallback is visible.",
    "agent.question.placeholder": "e.g. Which product categories drove the most revenue last quarter?",
    "agent.badge.demo": "Mock fallback available",
    "agent.badge.memory": "In-memory record",
    "agent.flow-hint": "Agent will inspect data, generate SQL, run tools, and summarize evidence.",
    "agent.run": "Run Agent",
    "agent.running": "Running Agent...",
    "agent.loading": "Running Agent Analysis...",
    ...
    "agent.result.title": "Agent Result",
    "agent.result.description": "Answer, SQL, evidence, warnings, and tool trace from this run.",
    "agent.result.answer": "Answer",
    "agent.result.sql": "SQL",
    "agent.result.evidence": "Evidence",
    "agent.result.warnings": "Warnings",
    "agent.result.trace": "Trace",
    "agent.result.tool-calls": "Tool Calls",
    "agent.result.no-tool-calls": "No tool calls recorded for this run.",
    "agent.result.tool-fallback": "Tool {{index}}",
    "agent.result.view-tool-payload": "View tool payload",
    "agent.result.status-unknown": "unknown",
    "agent.result.intent": "Intent",
    "agent.result.not-routed": "not routed",
    "agent.result.provider-requested": "Provider requested",
    ...
    "agent.result.memory-used": "Memory used",
    "agent.result.record-type": "Record",
    "agent.result.demo-record": "demo result",
