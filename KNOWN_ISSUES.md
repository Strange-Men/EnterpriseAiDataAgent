...
| ISSUE-017 | Command Palette labels still include hardcoded English descriptions | Low | Yes | Open | Codex | Add i18n keys for shortcut descriptions in a later UX pass |
